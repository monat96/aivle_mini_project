...
#     user_id = models.ForeignKey('accounts.CustomUser', related_name='username', on_delete=models.CASCADE)
...
#     user_id = models.ForeignKey('accounts.CustomUser', related_name='username', on_delete=models.CASCADE)
#     user_nickname = models.ForeignKey('accounts.CustomUser', related_name='nickname', on_delete=models.CASCADE)
...
#     board_id = models.ForeignKey(Board, on_delete=models.CASCADE)
#     user_id = models.ForeignKey('accounts.CustomUser', related_name='user_id', on_delete=models.CASCADE)
